...
class ChatterBot {
	...
	/**
	 * This constructor generate a new chatterbot object
	 * @param name - the bot name
     * @param repliesToIllegalRequest - list of possible response in case a
	 *                                legal request was sent to the bot
	 * @param repliesTollegalRequests -  list of possible response in case a
	 * 	                              illegal request was sent to the bot
	 */
	...
	/**
	 * This method generate a response for any request
